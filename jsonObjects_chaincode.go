...
func (t *FabricChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "queryObjectsByProprety" { //find rowObjects for owner X using rich query
		return t.queryObjectsByProprety(stub, args)
...
// =========================================================================================
func (t *FabricChaincode) queryObjectsByProprety(stub shim.ChaincodeStubInterface, args []string) pb.Response {
